...
def ENC(sig, key):
    ...
    print("length of string IV: ", len(IV.encode('utf-8')))
    print("length of string sig: ", len(sig.encode('utf-8')))
    ciphertext = encryptor.encrypt(sig.encode('utf-8'))
    return ciphertext
